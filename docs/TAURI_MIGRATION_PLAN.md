...
发布包到本地验证；当时的专用开关只允许 `v0.2.3`，不能用于其他版本。

2026-09-11 发布者针对 `v0.2.4` 再次明确授权同范围的一次性 unsigned 发布，并要求不下载
发布包到本地验证。2026-09-15 发布者对 `v0.2.5` 和 `v0.2.6` 作出同范围授权；2026-09-20 发布者对 `v0.2.7` 作出同范围授权；2026-09-21 发布者对 `v0.2.8` 作出同范围授权；2026-09-23 发布者对 `v0.2.9` 作出同范围授权；2026-09-24 发布者对 `v0.2.10` 作出同范围授权，当前专用开关只允许
`v0.2.10`，不能用于其他版本。
