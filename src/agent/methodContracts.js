...
export const METHOD_CONTRACTS = Object.freeze({
  ...
  "proxies.importCustom": ["customProxyParams", "operationResult"],
  "proxies.getCustom": ["idParams", "customProxyDetails"],
  "proxies.saveCustom": ["customProxyDetails", "operationResult"],
  "proxies.renameCustom": ["renameCustomProxyParams", "operationResult"],
  "proxies.removeCustom": ["idParams", "operationResult"],
